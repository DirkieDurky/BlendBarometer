                    ...
                    @foreach($questions as $question)
                        ...
                        <div class="mb-3">
                            ...
                            <div class="btn-group w-100" role="group">
                                <input type="radio" class="btn-check" name="{{ $fieldName }}" id="{{ $fieldName }}_nooit" value="Nooit" autocomplete="off" {{ $selectedAnswer === 'Nooit' ? 'checked' : '' }}>    
                                ...
                                <input type="radio" class="btn-check" name="{{ $fieldName }}" id="{{ $fieldName }}_af_en_toe" value="Af en toe" autocomplete="off" {{ $selectedAnswer === 'Af en toe' ? 'checked' : '' }}>
                                ...
                                <input type="radio" class="btn-check" name="{{ $fieldName }}" id="{{ $fieldName }}_vaak" value="Vaak" autocomplete="off" {{ $selectedAnswer === 'Vaak' ? 'checked' : '' }}>
