...
<x-admin.edit-questions.lesson-sidebar
    :subCategories="$lessonSubCategories"
    ...
    <section id="category-{{ $cat->id }}">
        ...
        @foreach ($lessonSubCategories->where('question_category_id', $cat->id) as $subCat)
            <section id="subcategory-{{ $subCat->id }}" class="mt-4">
                ...
                @forelse ($questions as $question)
                    <div class="d-flex align-items-center justify-content-between border rounded px-3 py-2 mb-2 bg-white">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{ route('admin.edit-lesson-questions') }}" class="btn btn-primary btn-sm me-3" style="padding: 0.4rem 1.1rem;"
                            ...
                            data-action='/admin/vragen-bewerken/lesniveau/{{ $question->id }}/update'
                            >Bewerken</a>
                ...
                <div class="mt-2">
                    <a href="{{ route('admin.edit-lesson-questions') }}" class="btn btn-sm btn-outline-primary border-2" style="padding: 0.4rem 1.1rem;"
                    data-bs-toggle="modal"
