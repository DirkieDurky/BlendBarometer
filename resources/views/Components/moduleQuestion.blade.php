    ...
    <div class="d-flex gap-3">
        <div class="form-check position-relative">
            ...
            <label
                ...
                for="little-{{ $questionId }}" style="width: 260px; height: 110px;">
        ...
        <div class="form-check position-relative">
            ...
            <label
                class="form-check-label d-flex flex-column align-items-center justify-content-center p-3 border rounded border-secondary text-center cursor-pointer"
                for="sometimes-{{ $questionId }}" style="width: 260px; height: 110px;">
        ...
        <div class="form-check position-relative">
            ...
            <label
                class="form-check-label d-flex flex-column align-items-center justify-content-center p-3 border rounded border-secondary text-center cursor-pointer"
                for="often-{{ $questionId }}" style="width: 260px; height: 110px;">
