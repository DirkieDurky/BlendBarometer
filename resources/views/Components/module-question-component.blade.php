...
<div class="row flex-nowrap gap-4 mx-0" role="group">
    ...
    <div class="col py-4 d-flex flex-column justify-content-center align-items-center">
        <input type="radio" class="module-input visually-hidden" name="{{ $fieldName }}" id="{{ $fieldName }}_explore" value="0" autocomplete="off" {{ $selectedAnswer === '0' ? 'checked' : '' }} required>
    ...
    <div class="col py-4 d-flex flex-column justify-content-center align-items-center">
        <input type="radio" class="module-input visually-hidden" name="{{ $fieldName }}" id="{{ $fieldName }}_apply" value="1" autocomplete="off" {{ $selectedAnswer === '1' ? 'checked' : '' }} required>
