        ...
        <section class="py-4">
            ...
            <div class="row gx-4">
                <div class="col">
                    ...
                    <input class="form-control" type="text" name="name" id="name" required placeholder="Naam van docent/ontwikkelaar" value='{{ old('name', session('name')) }}'>
                </div>
                <div class="col">
                    <label for="email">E-mailadres</label>
                    <input class="form-control" type="email" name="email" id="email" required placeholder="eerder-al-ingevuld@avans.nl" value='{{ old('email', session('email')) }}' disabled>
                </div>
            </div>
        </section>
        ...
        <section class="py-4">
            ...
            <div class="row gx-4">
                <div class="col">
                    ...
                    <input class="form-control" type="text" name="course" id="course" required placeholder="Naam van de opleiding" value='{{ old('course', session('course')) }}'>
                </div>
                <div class="col">
        ...
        <section class="py-4">
            ...
            <div class="row w-50">
                <div class="col pe-0">
                    ...
                    <input class="form-control" name="module" type="text" id="module" required placeholder="Naam van de module" value='{{ old('module', session('module')) }}'>
                </div>
            </div>

            <div class="mt-4">
                <label for="summary">Samenvatting</label>
                <textarea class="form-control @error('summary') is-invalid @enderror" rows="4" name="summary" id="summary" maxlength="2000" placeholder="Schrijf een korte samenvatting van de module">{{ old('summary', session('summary')) }}</textarea>
                @error('summary')
