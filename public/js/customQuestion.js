...
function addQuestion() {
    ...
    questionField.innerHTML = `
        ...
        <div class="row gap-4 mx-0" role="group">
            ...
            <label class="form-check-label border-2 border rounded shadow-sm col py-4 d-flex flex-column justify-content-center align-items-center" for="${fieldName}_nooit">
            ...
            <label class="form-check-label border-2 border rounded shadow-sm col py-4 d-flex flex-column justify-content-center align-items-center" for="${fieldName}_af_en_toe">
                <span style="font-size: 2rem;">🙂</span>
            ...
            <label class="form-check-label border-2 border rounded shadow-sm col py-4 d-flex flex-column justify-content-center align-items-center" for="${fieldName}_vaak">
                <span style="font-size: 2rem;">😃</span>
